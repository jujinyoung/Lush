...
<link rel="stylesheet" type="text/css" href="/content/renewal/pc/css/reset.css">
<link rel="stylesheet" type="text/css" href="/content/renewal/pc/css/layout.css">
<style>
/* 
@import url("/WEB-INF/inc/footer/reset.css");
@import url("/WEB-INF/inc/footer/layout.css");
 */
script {
    display: none;
}

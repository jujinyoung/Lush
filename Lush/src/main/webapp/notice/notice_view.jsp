					...
					<div class="tab-inner on">
						<table class="list-table read">
							...
							<tr>
								<th>제목</th>
								<td>
									<strong>${viewContent.n_title}</strong>
								</td>
							</tr>
							<tr>
								<th>작성자</th>
								<td>
									${viewContent.n_writer }</td>
							</tr>
							<tr>
								<th>작성일</th>
								<td>
									${viewContent.n_date }</td>
							</tr>
							<tr>
								<th>조회수</th>
								<td>
									${viewContent.n_hits }</td>
							</tr>
							</thead>
							<tbody>
							<tr>
								<td colspan="2">
									<div class="board-contents">
										...
										${fn:replace(viewContent.n_content, newLineChar, "<br> ")}
						...
						<div class="btn-wrap right medium">
							<a href="/Lush/notice/list.do" class="border-btn">목록</a>
						</div>
					</div>
					<!-- read page //-->
				</div>

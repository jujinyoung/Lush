...
<header id="header">
	...
	<div class="header-wrap no-bor main-header">
		<div class="left-menu flex">
			...
			<nav>
				<ul class="flex left">
					<li class="open-menu"><a href="/categories/index/113"
						id="atag">제품</a>
					...
					<li><a href="/board/shop">매장안내</a></li>
					<li><a href="/categories/index/86">스파</a></li>
		...
		<div class="right-menu">
			<ul>
				<li><a href="/service/shoplive" class="short-live"><img
				...
				<li class="open-menu" id="atag3"><a href="/users/login"
